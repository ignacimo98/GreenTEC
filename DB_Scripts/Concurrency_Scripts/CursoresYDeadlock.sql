...
DECLARE UsosCarros CURSOR SCROLL FOR SELECT IdVehiculo
...
WHILE @@fetch_status = 0
  BEGIN
    UPDATE GREEN_TEC.Vehiculo SET Usos = 1 WHERE CURRENT OF UsosCarros
    --WAITFOR DELAY '00:00:05'
...
DECLARE UsosCarros2 CURSOR SCROLL FOR SELECT IdVehiculo
...
WHILE @@fetch_status = 0
  BEGIN
    UPDATE GREEN_TEC.Vehiculo SET Usos = 0 WHERE CURRENT OF UsosCarros2
    -- WAITFOR DELAY '00:00:05'
