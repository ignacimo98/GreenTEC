...
SELECT IdProyectoInvestigacion AS [Numero de Proyecto], Presupuesto AS [Presupuesto],
       E.NombreVulgar AS [Nombre De Depredador en Investigacion],
       CE.Nombre AS [Caracteristica], CE.Valor AS [Valor],
...
CREATE VIEW [Parques Nacionales por Comunidad] WITH SCHEMABINDING AS
...
CREATE VIEW [Area Protegida por Comunidad] WITH SCHEMABINDING AS
...
GO
SELECT * FROM [Area Total por Parque Nacional];
GO
